...
cfg.deca_model_path = os.path.join(cfg.deca_dir, 'data', 'deca_model.tar')
...
cfg.train.lr = 5e-5
cfg.train.min_lr = 5e-5
cfg.train.decay = 1e-4
...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, help='cfg file path',default='configs/release_version/deca_detail.yml')
